...
export const SCENARIOS = [
...

  {
    ...
    expected: { area: 'Booking engine', type: 3, priority: 'P1', kbId: 'KB-001', minConfidence: 35 },
    rationale: 'outage + all guests + cannot book + revenue + urgent → P1 despite self-service fix. Urgency words dilute token overlap so conf ~40; 35 is a realistic floor.',
  },
  {
    id: 'TC-07',
    category: 'Urgency / Priority',
    ...
    expected: { area: 'Analytics', type: 2, priority: 'P1', kbId: 'KB-002', minConfidence: 50 },
    rationale: 'business-critical + entire team → P1 urgency on top of known Type 2 bug. Urgency words dilute token overlap so conf ~57; 50 is a realistic floor.',
  },
  {
    id: 'TC-08',
    category: 'Urgency / Priority',
...

  {
    ...
    expected: { priority: 'P3', minConfidence: 20 },
    rationale: 'Both Account and Analytics signals fire. Keyword-based classifier picks Analytics (3 hits vs Account 2 hits). No priority escalation. Area check omitted — multi-signal ambiguity is expected.',
  },
  {
    id: 'TC-18',
    category: 'Multi-area',
